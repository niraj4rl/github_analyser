    ...
    <div className="max-w-6xl mx-auto">
      <div className="glass-panel rounded-lg p-8 mb-8">
        <div className="flex flex-col md:flex-row gap-8">
          ...
          <div className="flex-1">
            <h1 className="text-4xl font-bold text-foreground mb-2">{analysis.profile.name || analysis.profile.login}</h1>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        <div className="glass-panel rounded-lg p-6">
          ...
          <div className="text-5xl font-bold text-primary mb-4">{analysis.hire_score.toFixed(1)}</div>
        ...
        <div className="glass-panel rounded-lg p-6">
          <div className="text-sm text-muted mb-2">Current State</div>
